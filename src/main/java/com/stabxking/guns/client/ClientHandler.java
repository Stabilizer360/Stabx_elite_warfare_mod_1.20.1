...
import com.stabxking.guns.client.handler.*;
import com.stabxking.guns.client.render.gun.ModelOverrides;
import com.stabxking.guns.client.render.gun.model.GrenadeLauncherModel;
import com.stabxking.guns.client.render.gun.model.MiniGunModel;
import com.stabxking.guns.client.render.gun.model.SimpleModel;
import com.stabxking.guns.client.screen.AttachmentScreen;
import com.stabxking.guns.client.screen.WorkbenchScreen;
import com.stabxking.guns.client.util.PropertyHelper;
import com.stabxking.guns.debug.IEditorMenu;
import com.stabxking.guns.debug.client.screen.EditorScreen;
import com.stabxking.guns.enchantment.EnchantmentTypes;
import com.stabxking.guns.init.ModBlocks;
import com.stabxking.guns.init.ModContainers;
import com.stabxking.guns.init.ModItems;
import com.stabxking.guns.item.GunItem;
import com.stabxking.guns.item.IColored;
import com.stabxking.guns.item.attachment.IAttachment;
import com.stabxking.guns.network.PacketHandler;
import com.stabxking.guns.network.message.C2SMessageAttachments;
...
public class ClientHandler
{
    ...
    public static void onRegisterCreativeTab(CreativeModeTab event)
    {
        event.getDisplayItems(new ResourceLocation(Reference.MOD_ID, "creative_tab"), builder ->
        {
