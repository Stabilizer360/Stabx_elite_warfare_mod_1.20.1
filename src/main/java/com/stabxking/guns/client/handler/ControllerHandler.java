...
import com.stabxking.guns.client.GunButtonBindings;
...
import com.stabxking.guns.network.message.C2SMessageUnload;
...
public class ControllerHandler
{
    ...
    @SubscribeEvent
    public void onButtonInput(Controller event)
    {
