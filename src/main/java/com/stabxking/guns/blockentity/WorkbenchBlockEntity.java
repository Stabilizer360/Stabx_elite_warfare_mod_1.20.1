package com.stabxking.guns.blockentity;

import com.stabxking.guns.blockentity.inventory.IStorageBlock;
import com.stabxking.guns.common.container.WorkbenchContainer;
import com.stabxking.guns.init.ModTileEntities;
...
public class WorkbenchBlockEntity extends SyncedBlockEntity implements IStorageBlock
{
    ...
    {
        return Component.translatable("container.skew.workbench");
    }
