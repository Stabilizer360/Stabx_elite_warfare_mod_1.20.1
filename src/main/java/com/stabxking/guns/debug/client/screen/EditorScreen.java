package com.stabxking.guns.debug.client.screen;
...
import com.stabxking.guns.util.ScreenUtil;
...
public class EditorScreen extends Screen
{
    ...
    public void render(PoseStack poseStack, int mouseX, int mouseY, float partialTicks)
    {
        ...
        Screen.getTooltipFromItem(poseStack, this.font, this.getTitle(), this.windowLeft + 5, this.windowTop + 6, 0xFFFFFF);
    }
